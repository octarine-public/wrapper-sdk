// @ts-ignore
import { invoker_ghost_walk as ImportSDK } from "github.com/octarine-public/wrapper/index"

import type { Ability } from "../../Base/Ability"

export declare class invoker_ghost_walk extends Ability {
	/**
...
export const c_invoker_ghost_walk = ImportSDK as unknown as typeof invoker_ghost_walk
