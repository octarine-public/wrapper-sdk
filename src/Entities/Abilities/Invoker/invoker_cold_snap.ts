// @ts-ignore
import { invoker_cold_snap as ImportSDK } from "github.com/octarine-public/wrapper/index"

import type { Ability } from "../../Base/Ability"

export declare class invoker_cold_snap extends Ability {
	/**
...
export const c_invoker_cold_snap = ImportSDK as unknown as typeof invoker_cold_snap
