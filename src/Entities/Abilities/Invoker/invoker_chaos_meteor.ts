// @ts-ignore
import { invoker_chaos_meteor as ImportSDK } from "github.com/octarine-public/wrapper/index"

import type { Ability } from "../../Base/Ability"

export declare class invoker_chaos_meteor extends Ability {
	/**
...
export const c_invoker_chaos_meteor = ImportSDK as unknown as typeof invoker_chaos_meteor
